    ...
    <div class="modal p-6 animate__animated"  :class="{'is-active animate__fadeIn': this.$store.state.aboutStatus}">
        <div class="modal-background"></div>
            <div class="modal-card game-help">
                <section class="modal-card-body about">
                    <button class="delete is-pulled-right" @click="removeAbout" aria-label="close"></button>
                    <div class="instruction">
                        <p><strong class="strong">Ўйин қоидалари</strong></p>
                        <br>    
                        <p>6 та уринишда кун <strong class="strong">СЎЗ</strong>ини топинг</p>
                        <br>
                    ...
                    <div class="examples mt-3">
                        ...
                        <p class=""><strong class="strong">С</strong> ҳарфи СЎЗ ичида бор ва тўғри ўриндан жой олган.</p>
                        <div class="example">
                            <div class="row has-text-centered is-flex has-text-weight-medium">
                        ...
                        <p><strong class="strong">Х</strong> ҳарфи СЎЗ ичида бор лекин, нотўғри ўриндан жой олган.</p>
                        <div class="example">
                            <div class="row has-text-centered is-flex has-text-weight-medium">
                        ...
                        <p class="mb-2"><strong class="strong">Б</strong> ҳарфи СЎЗ ичида иштирок этмаган.</p>
                    </div>
                    <br>
                    <p><strong class="strong">Ҳар куни сўз янгиланади!</strong></p>
                </section>
            </div>
    </div>
</template>
